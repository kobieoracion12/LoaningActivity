                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                 ...
                                                 <a class='btn btn-primary btn-sm'  title="Delete Student" onClick="javascript: return confirm('Please confirm deletion');" href='del_sps_customer.php?id=<?php echo $data['customer_id']; ?>"'><i class="fa fa-trash"></i></a>
                                            </td>
                                        </tr>
                                        <?php
                                        }  
...
<!-- modal update -->
<form action="edit_sps_customer.php" method="post">
