                            ...
                            <div class="card-body">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        $records1 = mysqli_query($config, "select * from customer_cred where category = 'spsv1'");
                                        $records2 = mysqli_query($config, "select * from loan_info,customer_cred where (loan_info.customer_id = customer_cred.customer_id) and (customer_cred.category = 'spsv1')");
                                        $records3 = mysqli_query($config, "select * from loan_type,customer_cred where (loan_type.loan_id = customer_cred.customer_id) and (customer_cred.category = 'spsv1')");
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                 ...
                                                 <a class='btn btn-primary btn-sm'  title="Delete Student" onClick="javascript: return confirm('Please confirm deletion');" href='del_spsv1_customer.php?id=<?php echo $data['customer_id']; ?>"'><i class="fa fa-trash"></i></a>
                                            </td>
                                        </tr>
                                        <?php
                                        }  
...
<!-- modal update -->
<form action="edit_spsv1_customer.php" method="post">
