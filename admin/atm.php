                            ...
                            <div class="card-body">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        $records1 = mysqli_query($config, "select * from customer_cred where category = 'atm'");
                                        $records2 = mysqli_query($config, "select * from loan_info,customer_cred where (loan_info.customer_id = customer_cred.customer_id) and (customer_cred.category = 'atm')");
                                        $records3 = mysqli_query($config, "select * from loan_type,customer_cred where (loan_type.loan_id = customer_cred.customer_id) and (customer_cred.category = 'atm')");
