                ...
                <div class="col-sm-5">
                    <div class="user-area dropdown float-right">
                        ...
                        <div class="user-menu dropdown-menu">
                            <a class="nav-link" href="#" data-bs-toggle="modal" data-bs-target="#modal-det"><i class="fa fa-user"></i> My Profile</a>
                            ...
                            <div class="card-body">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        $records = mysqli_query($config, "select * from customer_info where category = 'atm'");
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                 ...
                                                 <a class='btn btn-primary btn-sm'  title="Delete Student" onClick="javascript: return confirm('Please confirm deletion');" href='../php/del_atm_customer.php?id=<?php echo $data['customer_id']; ?>"'><i class="fa fa-trash"></i></a>
                                            </td>
                                        </tr>
                                        <?php
                                        }  
...
<!-- modal update -->
<form action="../php/edit_atm_customer.php" method="post">
          ...
          <form action="edit_users.php" method="post">
            <fieldset id="tableFieldset" disabled>
              <div class="mb-3">
                ...
                <input type="text" name="name" class="form-control" value="<?php echo $data['name'] ?>" placeholder="Enter First Name" Required>
                <label class="form-label">Position</label>
                <input type="text" name="position" class="form-control" value="<?php echo $data['position'] ?>" placeholder="Enter Last Name" Required><br>
              </div>
            </fieldset>
          </form>
        </div>
